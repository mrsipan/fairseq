...
### IWSLT'14 English to Spanish (Transformer)

The following instructions can be used to train a Transformer model on the [IWSLT'14 English to Spanish dataset](http://workshop2014.iwslt.org/downloads/proceeding.pdf).
...
# Preprocess/binarize the data
TEXT=examples/translation/wmt14.en-es
fairseq-preprocess --source-lang de --target-lang en \
    --trainpref $TEXT/train --validpref $TEXT/valid --testpref $TEXT/test \
